...
class DoublePannaScreen extends StatefulWidget {
  ...
  const DoublePannaScreen({Key? key, required this.bazar}) : super(key: key);
...
class _DoublePannaScreenState extends State<DoublePannaScreen> {
  ...
  // Double Panna numbers (numbers with exactly two same digits)
  List<String> get doublePannaNumbers {
    List<String> numbers = [];
    for (int i = 100; i <= 999; i++) {
      String numStr = i.toString();
      // Check if exactly two digits are same (double panna)
      int sameCount = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Double Panna - ${widget.bazar.name}'),
                ...
                children: [
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemCount: doublePannaNumbers.length > 50 ? 50 : doublePannaNumbers.length,
                      itemBuilder: (context, index) {
                        final number = doublePannaNumbers[index];
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixText: '₹ ',
                    prefixStyle: const TextStyle(color: AppTheme.accentColor),
