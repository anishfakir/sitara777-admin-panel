...
class StarlineGameScreen extends StatefulWidget {
  const StarlineGameScreen({Key? key}) : super(key: key);
...
class _StarlineGameScreenState extends State<StarlineGameScreen>
  ...
  // StarLine games
  final List<Map<String, dynamic>> _starlineGames = [
    {
      'name': 'Kalyan',
      'openTime': '09:00',
      'closeTime': '21:00',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('StarLine Games'),
  ...
  Widget _buildGameStatusCards() {
    return Container(
      ...
      child: ListView.builder(
        ...
        itemCount: _starlineGames.length,
        itemBuilder: (context, index) {
          final game = _starlineGames[index];
      ...
      children: [
        ...
        Card(
          child: Padding(
            ...
            child: Column(
              children: [
                _buildResultRow('Kalyan', '123', '09:00'),
                const Divider(),
                _buildResultRow('Milan Day', '234', '09:15'),
                const Divider(),
                _buildResultRow('Rajdhani Day', '345', '09:30'),
              ],
            ),
          ),
        ),
